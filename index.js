...
//   return result;
// }
  //  const {algo, binarySearchAlgo} = require('./binarySearch.js');

// console.log(merge([1,8,5,9],[11,19,15,17,18]));
// const binarySearchAlgo  = require ('./binarySearch.js');
  //  console.log(binarySearchAlgo([2,5,6,9,13,15,28,30],28)); 
  //  const algo = require ('./binarySearch.js');
  //  algo()
